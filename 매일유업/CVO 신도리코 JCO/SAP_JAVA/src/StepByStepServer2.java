...
*/
public class StepByStepServer2 {
...
//	/private static final Logger logger = LoggerFactory.getLogger("MPSLinkage");
	...
	static Logger logger = Logger.getLogger(StepByStepServer2.class);
...
*/
	...
	static public void step7DataRepository() {
		...
		exportList.add("TKNUM_CNT_R", JCoMetaData.TYPE_CHAR, 6, 0, 0, null, null, JCoListMetaData.EXPORT_PARAMETER, null, null);
		exportList.add("VBELN_CNT_R", JCoMetaData.TYPE_CHAR, 6, 6, 0, null, null, JCoListMetaData.EXPORT_PARAMETER, null, null);
		exportList.lock();
		importList.add("TKNUM_CNT", JCoMetaData.TYPE_CHAR, 6, 0, 0, null, null, JCoListMetaData.IMPORT_PARAMETER, null, null);
		importList.add("VBELN_CNT", JCoMetaData.TYPE_CHAR, 6, 6, 0, null, null, JCoListMetaData.IMPORT_PARAMETER, null, null);
		importList.lock();
...
*/
	...
	static class REPORT_PROGRAM {
		...
		public void reportgenerate() throws IOException, InterruptedException {
	        ProcessBuilder builder = new ProcessBuilder("cmd.exe", "/c", "start", "D:/SINDOH/InvoicePrintingSystem/ReportGenerator/ReportGenerator.exe");
			builder.directory(new File("D:/SINDOH/InvoicePrintingSystem/ReportGenerator/"));
